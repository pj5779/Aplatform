...
const EnterJobPostingDetail = () => {
  ...
  useEffect(() => {
    ...
    console.log(`Navigating to: /board/jobPostingUpdate/${jbp.jbpSq}`);
  }, [jbpSq]);
  ...
  // updatePage 이동 tset중
// const goUpdatePage = (e) => {
//     setIsEditable(false);
//     navigate(`/board/jobPostingUpdate/${jbp.jbpSq}`,{state: e.target.value});
//   };
...
export default EnterJobPostingDetail;
