            ...
            <div class="col pb-3 pt-3">
                <div class="row">
                    <h1 class="form-group col-md-12">
                        <input type="text" value="" maxlength="20" class="form-control text-3 h-auto py-2" name="name"
                    ...
                    <section class="call-to-action with-full-borders mb-2 mainContainer">
                        ...
                        <div class="row col-sm-10 col-lg-10">
                            <div class="col-sm-4 col-lg-4">
                                <input type="text" value="" maxlength="100" class="form-control text-3 h-auto py-2"
                                ...
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="radios"
                                            id="tabContent16Radio1" value="201" required /> 남
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="radios"
                                            id="tabContent16Radio2" value="202" required /> 여
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-2 col-lg-2">
                                <input type="text" value="" maxlength="100" class="form-control text-3 h-auto py-2"
                                    name="name" placeholder="생년월일" required />
                            </div>
                            <div class="col-sm-2 col-lg-4">
                                <input type="text" value="" maxlength="100" class="form-control text-3 h-auto py-2"
                                    name="name" placeholder="전화번호" required />
                            </div>
                            <hr class="mt-3 mb-1" />
                            <div class="col-sm-2 col-lg-8">
                                <input type="text" value="" maxlength="100" class="form-control text-3 h-auto py-2"
                                    name="name" placeholder="주소" required />
                            </div>
                            <div class="col-sm-3 col-lg-4">
                                <input type="text" value="" maxlength="100" class="form-control text-3 h-auto py-2"
                                    name="name" placeholder="이메일" required />
                            </div>
                            <hr class="mt-3 mb-1" />
                            <div class="col-sm-4 col-lg-3">
                                <input type="text" value="" maxlength="100" class="form-control text-3 h-auto py-2"
                                    name="name" placeholder="희망연봉" required />
                            </div>
                            <div class="col-sm-3 col-lg-3">
                                <input type="text" value="" maxlength="100" class="form-control text-3 h-auto py-2"
                                    name="name" placeholder="최종학력" required />
                            </div>
                            <div class="col-sm-3 col-lg-3">
                                <input type="text" value="" maxlength="100" class="form-control text-3 h-auto py-2"
                                    name="name" placeholder="학점" required />
                            </div>
